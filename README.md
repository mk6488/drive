...
The current app still runs as a mock-backed preview. Firestore and Storage helpers are lazy service boundaries only, so the preview app does not require real Firebase values yet.
